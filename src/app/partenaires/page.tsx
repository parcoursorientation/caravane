...
export default function PartenairesPage() {
  ...
  const filteredPartenaires = selectedType === "all" 
    ? partenaires 
  ...
  const typeOrder = ['ORGANISATEUR', 'PARTENAIRE', 'SPONSOR', 'MEDIA', 'INSTITUTION'];
      ...
      <div className="bg-gradient-safe text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Découvrez les organisateurs, partenaires et sponsors qui contribuent au succès des Portes Ouvertes
          </p>
        </div>
      </div>
        ...
        {Object.keys(groupedPartenaires).length === 0 ? (
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-500">Aucun partenaire ne correspond à vos critères de filtrage.</p>
            </CardContent>
          </Card>
        ) : (
          typeOrder.map(type => {
              ...
              <div key={type} className="mb-12">
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-2">
                    {getTypeIcon(type)}
                    <h2 className="text-2xl font-bold text-gray-900">{getTypeLabel(type)}</h2>
                  </div>
                      ...
                      <CardContent>
                        ...
                        {partenaire.siteWeb && (
                          <Button 
                            ...
                            size="sm" 
                            className="w-full"
                            onClick={() => window.open(partenaire.siteWeb, '_blank')}
                          >
        ...
        <Card className="mt-12">
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium mb-2">Pourquoi devenir partenaire ?</h4>
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mb-3">
                  Envoyez-nous un message via notre formulaire de contact en sélectionnant "Partenariat".
                </p>
                <Button asChild>
