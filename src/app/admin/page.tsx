    ...
    <Layout isAdmin>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {getGreeting()}, {user?.name} - Voici un aperçu de votre
              plateforme
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
        <Card
          ...
          onClick={() => !refreshing && router.push("/admin/lycees")}
        >
        ...
        <Card
          ...
          onClick={() => !refreshing && router.push("/admin/exposants")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">
              Exposants
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">Exposants participants</p>
          </CardContent>
        </Card>
        ...
        <Card
          ...
          onClick={() => !refreshing && router.push("/admin/evenements")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">
              Événements
        ...
        <Card
          ...
          onClick={() => !refreshing && router.push("/admin/inscriptions")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">
              Inscriptions
        ...
        <Card
          ...
          onClick={() => !refreshing && router.push("/admin/contact-messages")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">
              Messages
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">Total des messages</p>
          </CardContent>
        </Card>

        <Card
          className={`hover:shadow-lg transition-all duration-200 cursor-pointer border-l-4 border-l-cyan-500 ${
            refreshing ? "opacity-75" : ""
          }`}
          onClick={() => !refreshing && router.push("/admin/contact-messages")}
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-green-600 mt-1">Messages récents</p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <CardContent>
              <div className="flex gap-2">
                <Button
                  size="sm"
                  className="flex-1"
                  onClick={() => router.push("/admin/lycees?action=add")}
                >
                ...
                <Button
                  ...
                  size="sm"
                  className="flex-1"
                  onClick={() => router.push("/admin/lycees")}
                >
          ...
          <Card className="hover:shadow-lg transition-all duration-200 group">
            <CardHeader>
              ...
              <CardDescription className="text-sm">
                Gérez les exposants participants
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex gap-2">
                <Button
                  size="sm"
                  className="flex-1"
                  onClick={() => router.push("/admin/exposants?action=add")}
                >
                  <Plus className="h-3 w-3 mr-1" />
                  Ajouter
                </Button>
            ...
            <CardContent>
              <div className="flex gap-2">
                <Button
                  size="sm"
                  className="flex-1"
                  onClick={() => router.push("/admin/evenements?action=add")}
                >
                  <Plus className="h-3 w-3 mr-1" />
                  Ajouter
                </Button>
              ...
              <div className="flex gap-2">
                ...
                {stats.recentInscriptions > 0 && (
                  <Badge variant="destructive" className="text-xs">
                    {stats.recentInscriptions} nouveau
                    {stats.recentInscriptions > 1 ? "x" : ""}
                  </Badge>
                )}
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="flex gap-2">
                ...
                {stats.recentMessages > 0 && (
                  <Badge variant="destructive" className="text-xs">
                    {stats.recentMessages} nouveau
                    {stats.recentMessages > 1 ? "x" : ""}
                  </Badge>
                )}
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1"
                  onClick={() =>
                    router.push("/admin/compte-a-rebours?action=add")
                  }
                >
                  <Plus className="h-3 w-3 mr-1" />
                  Ajouter
                ...
                <Button
                  ...
                  size="sm"
                  className="flex-1"
                  onClick={() => router.push("/admin/compte-a-rebours")}
                >
                  <Eye className="h-3 w-3 mr-1" />
                  Voir
                </Button>
            ...
            <CardContent>
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1"
                  onClick={() =>
                    router.push("/admin/contacts-exposants?action=add")
                  }
                >
                  <Plus className="h-3 w-3 mr-1" />
                  Ajouter
                ...
                <Button
                  ...
                  size="sm"
                  className="flex-1"
                  onClick={() => router.push("/admin/contacts-exposants")}
                >
                  <Eye className="h-3 w-3 mr-1" />
                  Voir
                </Button>
